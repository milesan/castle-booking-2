-- Simplified bug alert trigger - Final Version
...
SELECT 
  '✅ Trigger created: ' || tgname || ' on table ' || tgrelid::regclass::text as trigger_status
FROM pg_trigger 
WHERE tgname = 'bug_alert_trigger';

-- Check if function exists
SELECT '✅ Function notify_bug_alert created successfully' AS function_status
WHERE EXISTS (
...
RETURNING '✅ Test bug report created with ID: ' || id::text as result, created_at;

-- Final message
SELECT '📧 Bug report created and email trigger executed!' as message
UNION ALL
SELECT '📬 Check redis213@gmail.com for the email alert!' as message
UNION ALL
SELECT '⚡ The system is now set up to automatically email bug reports!' as message;
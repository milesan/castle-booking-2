...
-- Check what tables exist in the net schema
SELECT 'Available net schema tables:' as info;
SELECT table_name 
FROM information_schema.tables 
WHERE table_schema = 'net'
ORDER BY table_name;

-- Check if there are any http requests in queue
SELECT 'Checking net._http_request_queue:' as info;
SELECT COUNT(*) as pending_requests FROM net._http_request_queue;

-- Simple message to confirm
SELECT 'Bug report inserted and trigger executed. Check redis213@gmail.com for the email alert!' as message;
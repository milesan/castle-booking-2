    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Modal Container - Properly centered on desktop */}
          <motion.div
          ...
          >
            <div className="bg-surface border border-border rounded-sm shadow-2xl w-full max-w-md max-h-[90vh] overflow-hidden flex flex-col">
              {/* Header */}
